...
const About = () => {
  ...
  return (
    <>
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p>
            ...
            sleek designs, and dynamic animations, making sure every interface
            is engaging and intuitive.
          </p>
          <p>
            I’m a naturally curious and hardworking developer who thrives in
            collaborative environments. I enjoy growing with teams, learning
            from each challenge, and working together to create impactful
            solutions. I never back down from a problem and persist until I find
      ...
      <Loader type="square-spin"></Loader>
    </>
  )
}
